...
CMeshInstancingShader::CMeshInstancingShader()
{
}
...
bool CMeshInstancingShader::Init()
{
	if (!LoadVertexShader("MeshInstancingVS", TEXT("Mesh.fx"), SHADER_PATH))
	{
		return false;
	}

	if (!LoadPixelShader("MeshInstancingPS", TEXT("Mesh.fx"), SHADER_PATH))
	{
		return false;
	}
