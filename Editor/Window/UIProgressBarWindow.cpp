...
bool CUIProgressBarWindow::Init()
{
	...
	m_MinInput = CreateWidget<CEditorInput>("최소비율", 80.f, 30.f);
	m_MinInput->SetInputType(EImGuiInputType::Float);
	line = CreateWidget<CEditorSameLine>("Line");
	line->SetSpacing(-5.f);
	m_MaxInput = CreateWidget<CEditorInput>("최대비율", 80.f, 30.f);
	m_MaxInput->SetInputType(EImGuiInputType::Float);
	m_ValueInput = CreateWidget<CEditorInput>("채움비율", 80.f, 30.f);
