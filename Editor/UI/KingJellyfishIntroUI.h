...
protected:
    CKingJellyfishIntroUI();
    CKingJellyfishIntroUI(const CKingJellyfishIntroUI& Window);
    virtual ~CKingJellyfishIntroUI();
...
public:
    ...
    virtual void Render();
    virtual CKingJellyfishIntroUI* Clone();
